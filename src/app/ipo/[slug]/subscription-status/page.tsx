...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return generateIpoPageMetadata('subscriptionStatus', basicData, detailData);
}
...
export default async function SubscriptionStatusPage({ params }: { params: Promise<{ slug: string }> }) {
  const { slug } = await params;
